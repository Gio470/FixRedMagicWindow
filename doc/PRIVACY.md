...
### FixRedMagicWindow 隐私政策

版本：1.3 修订与生效日期：2022年4月16日

#### 前言

为帮助您使用 FixRedMagicWindow 产品或服务，我们可能收集与提供服务相关的设备信息或申请设备权限，您有权拒绝或撤回授权；
...
目录
1.  引言
2. FixRedMagicWindow 处理设备信息的法律依据
3. 我们如何收集和使用您的设备信息
3.1 向您提供产品和/或服务
A. 向您提供 FixRedMagicWindow 产品和/或服务的核心业务功能
B．向您提供 FixRedMagicWindow 产品和/或服务的附加业务功能
3.2 征得授权同意的例外
4. 我们如何转让、公开披露您的设备信息
4.1 转让您的设备信息
4.2 公开披露
...
【特别提示】请您在使用我们的各项产品和/或服务前，仔细阅读并充分理解本政策。重点内容我们已采用粗体表示，希望您特别关注。一旦您使用或继续使用 FixRedMagicWindow 产品/服务，即表示您同意我们按照本政策处理您的相关信息。

2. FixRedMagicWindow 处理设备信息的法律依据

如果您是中华人民共和国大陆地区的用户，我们将依据《中华人民共和国网络安全法》、《信息安全技术 个人信息安全规范》（GB/T 35273-2017）以及其他相关法律法规收集和使用您的设备信息或申请设备权限，为您提供 FixRedMagicWindow 产品或服务。 我们通常只会在征得您同意的情况下收集您的设备信息。 

3. 我们如何收集和使用您的设备信息

我们会遵循正当、合法、必要的原则，出于本政策所述的以下目的，收集和使用您在使用服务过程中主动提供或因使用 FixRedMagicWindow 产品和/或服务而产生的设备信息。如果我们要将您的设备信息用于本政策未载明的其它用途，或基于特定目的将收集而来的信息用于其他目的，我们将以合理的方式向您告知，并在使用前再次征得您的同意。

3.1 向您提供产品和/或服务

A. 向您提供 FixRedMagicWindow 产品和/或服务的核心业务功能

为实现 FixRedMagicWindow 的核心业务功能，我们可能需要向您收集设备信息。以下将详细列出 FixRedMagicWindow 的核心业务功能及为实现该功能所需收集的设备信息，若您拒绝收集，则无法使用该服务。

查看设备中的所有应用信息。 FixRedMagicWindow 会读取您的设备应用列表；

搜索功能。 当您使用 FixRedMagicWindow 提供的搜索功能时，我们可能会使用应用数据缓存，收集您设备上的信息并进行本地存储。 该信息通常无法单独识别您的个人身份。

B．向您提供 FixRedMagicWindow 产品和/或服务的附加业务功能

为了向您提供更优质的产品和服务，我们可能需要收集下述信息。 如果您拒绝提供下述信息，不影响您正常使用 3.1 A 项所描述的 FixRedMagicWindow 核心业务功能，但我们无法向您提供某些特定功能和服务。

~Bug 分析。 FixRedMagicWindow 使用微软公司出品的第三方 Bug 分析平台 Microsoft AppCenter 进行设备数据的收集和分析，以发现软件运行中可能出现的问题和故障，并予以改进。~(已经停用)
...
g. 根据您的要求签订和履行合同所必需的；
h. 用于维护 FixRedMagicWindow 的产品和/或服务的安全稳定运行所必需的，例如发现、处置产品或服务的故障；
i. 法律法规规定的其他情形。
```
...
6.1 本政策为《 FixRedMagicWindow 用户协议》的重要组成部分。 FixRedMagicWindow 保留不时更新或修改本政策的权利。
...
6.4 若您不同意修改后的隐私政策，您有权并应立即停止使用 FixRedMagicWindow 的服务。如果您继续使用 FixRedMagicWindow 的服务，则视为您接受 FixRedMagicWindow 对本政策相关条款所做的修改。
...
设备： 设备是指可用于访问 FixRedMagicWindow 产品和/或服务的装置，例如台式计算机、笔记本电脑、平板电脑或智能手机。
...
信息收集技术： 我们在《 FixRedMagicWindow 隐私政策》中所述的“自动收集”包括以下方式： A. Cookie（曲奇档案） Cookie 是您浏览网页时，网站服务器放在客户端（您的计算机、移动电话或其他智能终端内）里面的一个小小的文本文件，当您再次访问相应网站时，网站就可通过 Cookie 识别您的浏览器。Cookie 可能会存储用户偏好及其他信息。您可以将浏览器配置为拒绝所有 Cookie 或在网站发送 Cookie 时显示提示。不过，如果没有 Cookie，某些网站功能或服务可能无法正常工作。具体可参见《 FixRedMagicWindow  Cookie 指引》。 B. Web beacon（网络信标） Web beacon 是装嵌在网站或电邮内的电子图像文件案或其他技术，可用于计算访客数目、记录您是否及何时阅览电邮或网站，或用以使用某些 Cookie。 C. Log files（日志文件） Log files 储存自动收集的若干数据。该等数据包括互联网协议（ IP ）地址、浏览器类型、互联网服务提供商（ ISP ）、引用/退出页面、操作系统、日期/时间戳和点击流数据等。 D. ET Tag（实体标签） ET Tag 是在互联网浏览器与互联网服务器之间背后传送的 HTTP 协议标头，可代替 Cookie，用以追踪个别使用者，使我们可更深入地了解和改善我们的服务。 E. JavaScript JavaScript 是一种编程语言，用于制作更具互动性和动态的网页。JavaScript 可以设定 Cookie、阅读 Cookie 及删除 Cookie。
